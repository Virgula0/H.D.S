...
var ErrInternalServerError = errors.New("ops, an internal server error occurred, this may be unintented btw :( open an issue specifying the steps to reproduce the problem")
